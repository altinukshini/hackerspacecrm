...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $settings = [
            ...
            ['key' => 'orgname', 'value' => Config::get('hackerspacecrm.orgname')],
            ['key' => 'orgdescription', 'value' => Config::get('hackerspacecrm.orgdescription')],
            ['key' => 'address', 'value' => Config::get('hackerspacecrm.address')],
