	  ...
	  <div class="col-md-4">
		...
		<div class="box box-primary">
		  <div class="box-body box-profile">
			...
			<p class="text-muted text-center">{{ $user->username }}</p>
		  	<p class="text-muted text-center"><i class="fa fa-circle text-success"></i> In Space</p>
		...
		<div class="box box-primary">
		  ...
		  <div class="box-body">
		    ...
		    <ul class="list-group list-group-unbordered">
			  <li class="list-group-item">
				<i class="fa fa-at margin-r-5"></i><b>Email:</b> <a class="pull-right">{{ $user->email }}</a>
			  </li>
			  <li class="list-group-item">
				<i class="fa fa-phone margin-r-5"></i><b>Phone:</b> <a class="pull-right">{{ $user->profile->phone }}</a>
			  </li>
			  <li class="list-group-item">
				<i class="fa fa-github margin-r-5"></i><b>Github:</b> <a class="pull-right">/{{ $user->profile->github_username }}</a>
			  </li>
			  <li class="list-group-item">
				<i class="fa fa-facebook margin-r-5"></i><b>Facebook:</b> <a class="pull-right">/{{ $user->profile->facebook_username }}</a>
			  </li>
			  <li class="list-group-item">
				<i class="fa fa-twitter margin-r-5"></i><b>Twitter:</b> <a class="pull-right">{{ '@'.$user->profile->twitter_username }}</a>
			  </li>
			  <li class="list-group-item">
				<i class="fa fa-linkedin margin-r-5"></i><b>LinkedIn:</b> <a class="pull-right">/{{ $user->profile->linkedin_username }}</a>
			  </li>
			</ul>
